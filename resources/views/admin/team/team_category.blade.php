...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Team Categories List</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section">
    <div class="row">
        <div class="col-lg-{{ (@$data==true) ?'12':'5'}}" >
            <div class="card" style="box-shadow:0px 0px 5px grey">
                ...
                <div class="row ml-2 mr-2">
                    @isset($data)
                    {{ Form::open(['url'=>route('teamcategory.update',$data->id)])}}
                    @method('put')
                    @else
                    {{ Form::open(['url'=>route('teamcategory.store')])}}
                    @endisset
        ...
        <div class="col-lg-7" >
            ...
            <div class="card" style="box-shadow:0px 0px 5px grey">
              <div class="card-body">
                <h5 class="card-title" style="float">Team Categories List</h5>

                <p>All Team Categories Listed Here.....</p>
                ...
                <div>
                  ...
                  <div class="btn-group " style="float:right;margin-right:10px;">
                    ...
                    <ul class="dropdown-menu bg-danger ">
                      ...
                      <li>
                          <a href="javascript:void(0);" class="dropdown-item text-white drop-hover to-team-category" data-multiple_action="delete">
                ...
                <form  action="{{route('to-team-cat')}}" method="post" id="full-form">
                    ...
                    @isset($team_cats)
                        @foreach($team_cats as $cat)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('teamcategory.edit',$cat->id)}}" class="">
                                        <i class="bi bi-pen-fill"></i>
                                    </a>
                                    <a href="javascript:;" data-id="{{ $cat->id }}" class=" delete-team-cat">
...
<script>
                ...
                $('.to-team-category').on('click', function(e){
                ...
                $(document).on('click', '.delete-team-cat', function(e) {
                   e.preventDefault();
                    var myAction = "{{route('teamcategory.destroy', 'id')}}"
