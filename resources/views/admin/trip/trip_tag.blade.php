        ...
        <div class="col-lg-{{ (@$data==true) ?'12':'5'}}">
            <div class="card" style="box-shadow:0px 0px 5px grey">
                ...
                <div class="row ml-2 mr-2">
                    @isset($data)
                    {{ Form::open(['url'=>route('triptag.update',$data->id)])}}
                    @method('put')
                    @else
                    {{ Form::open(['url'=>route('triptag.store')])}}
                    @endisset
        ...
        <div class="col-lg-7">
            ...
            <div class="card" style="box-shadow:0px 0px 5px grey">
              <div class="card-body">
                ...
                <form  action="{{route('to-trip-tag')}}" method="post" id="full-form">
                    ...
                    @isset($triptags)
                        @foreach($triptags as $tag)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('triptag.edit',$tag->id)}}" class="">
...
<script>
                ...
                $(document).on('click', '.delete-tag', function(e) {
                   e.preventDefault();
                    var myAction = "{{route('triptag.destroy', 'id')}}"
