...
@else
@section('title','Admin || Post Categories')
@endisset
@section('backend-css')
  <style>
  .drop-hover:hover{
...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Post Categories List</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section">
    <div class="row">
        <div class="col-lg-{{ (@$data==true) ?'12':'5'}}">
            <div class="card" style="box-shadow:0px 0px 5px grey">
                ...
                <div class="row ml-2 mr-2">
                    @isset($data)
                    {{ Form::open(['url'=>route('postcategory.update',$data->id)])}}
                    @method('put')
                    @else
                    {{ Form::open(['url'=>route('postcategory.store')])}}
                    @endisset
        ...
        <div class="col-lg-7">
            ...
            <div class="card" style="box-shadow:0px 0px 5px grey">
              <div class="card-body">
                <h5 class="card-title" style="float">Post Categories List</h5>

                <p>All Post Categories Listed Here.....</p>
                ...
                <div>
                  ...
                  <div class="btn-group " style="float:right;margin-right:10px;">
                    ...
                    <ul class="dropdown-menu bg-danger ">
                      ...
                      <li>
                          <a href="javascript:void(0);" class="dropdown-item text-white drop-hover to-perform-product" data-multiple_action="delete">
                ...
                <form  action="{{route('to-post-cat')}}" method="post" id="full-form">
                    ...
                    @isset($post_cats)
                        @foreach($post_cats as $cat)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('postcategory.edit',$cat->id)}}" class="">
...
<script>
                ...
                $('.to-perform-product').on('click', function(e){
                ...
                $(document).on('click', '.delete-cat', function(e) {
                   e.preventDefault();
                    var myAction = "{{route('postcategory.destroy', 'id')}}"
